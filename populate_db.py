...
toy_story = Movie(
    ...
    youtube_trailer="https://www.youtube.com/watch?v=KYz2wyBy3kc", duration="81 min")
...
man_from_earth = Movie(
        ...
        youtube_trailer="https://www.youtube.com/watch?v=9mOIxyRTY5I", duration="87 min")

reservoir_dogs = Movie(
    title="Reservoir Dogs", description="A jwewelery heist gone wrong",
    poster_mov="http://tinyurl.com/pxj87ly",
    youtube_trailer="https://www.youtube.com/watch?v=vayksn4Y93A", duration="99 min")
...
full_metal_jacekt = Movie(
        ...
        youtube_trailer="https://www.youtube.com/watch?v=Ks_MbPPkhmA", duration="116 min")
...
lord_of_war = Movie(
        ...
        youtube_trailer="https://www.youtube.com/watch?v=Ej83QvHuiNI", duration="142 min")
...
snatch = Movie(
        ...
        youtube_trailer="https://www.youtube.com/watch?v=ni4tEtuTccc", duration="102 min")
...
gravity = Movie(
        ...
        youtube_trailer="https://www.youtube.com/watch?v=OiTiKOy59o4", duration="102 min")
...
back_to_the_future = Movie(
        ...
        youtube_trailer="https://www.youtube.com/watch?v=qvsgGtivCgs", duration="116 min")
...
oldboy = Movie(
        ...
        youtube_trailer="https://www.youtube.com/watch?v=2HkjrJ6IK5E", duration="116 min")
